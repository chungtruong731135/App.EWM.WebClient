...
const UsersPage = () => {
  ...
  const handleExport = async () => {
    try {
      ...
      const res = await requestDOWNLOADFILE(`api/v1/supports/export`, _.assign({ type: 1 }, dataSearch));
    ...
    <>
      <div className="card card-xl-stretch mb-xl-9">
        <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between flex-wrap">
          <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Khách hàng mua khoá học online cùng thầy cô'}</h3>
        ...
        <ItemsList dataSearch={dataSearch} path="danh-sach-mua-khoa-hoc" type={1} />
      </div>
    </>
  );
};
