    ...
    <>
      <div className="card card-xl-stretch mb-xl-9">
        <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
          <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thảo luận, câu hỏi'}</h3>
          <div className="card-toolbar">
            <div className="col-xl-3 col-lg-6 btn-group align-items-center px-5 w-350px">
              <Checkbox
                onChange={e => {
                  setDataSearch({
                    ...dataSearch,
                    chuaThaoLuan: e.target.checked,
                  });
                }}
              >
