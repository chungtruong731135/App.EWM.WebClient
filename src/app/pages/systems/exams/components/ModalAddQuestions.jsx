...
const ModalItem = props => {
  const { modalVisible, setModalVisible, handleAddData, handleReplaceQuest, notInIds, maxOrder } = props;
  ...
  const onFinish = async () => {
    if (selectedRows?.length > 0) {
      ...
      temp?.map((i, ind) => {
        ...
        i.partId = dataModal?.partId ?? null;
        delete i.id;
      });
          ...
          <div className="row g-5">
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="btn-group align-items-center w-100">
                ...
                <input type="text" className="form-control form-control-sm ps-3" placeholder="Nhập số điểm" aria-label="Tìm kiếm" aria-describedby="basic-addon2" value={score} onChange={e => setScore(e.target.value)} />
              </div>
            </div>
            <div className="col-xl-4 col-lg-6">
              <div className="btn-group align-items-center w-100">
                <span className="fw-bold w-150px">Số thứ tự:</span>
                <input type="text" className="form-control form-control-sm ps-3" placeholder="Nhập từ số thứ tự" aria-label="Tìm kiếm" aria-describedby="basic-addon2" value={order} onChange={e => setOrder(e.target.value)} />
              </div>
            </div>
