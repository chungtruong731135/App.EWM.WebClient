...
const ModalItem = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoadding(true);
      const res = await requestGET(`api/v1/booksubjects/${id}`);
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = id
        ? await requestPUT_NEW(`api/v1/booksubjects/${id}`, formData)
        : await requestPOST_NEW(`api/v1/booksubjects`, formData);
