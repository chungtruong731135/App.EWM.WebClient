...
const UsersList = props => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'type',
      key: 'type',
      render: text => <div>{text == 0 ? 'Đại lý' : text == 1 ? 'Cộng tác viên' : 'Khác'}</div>,
    },

    {
      ...
      render: (text, record, index) => {
        return (
          <div className="d-flex flex-column">
            <span className="text-gray-800 text-hover-primary mb-1 fw-bolder">{record?.collectorFullName}</span>
    ...
    },
    {
      ...
      key: 'courseType',
      render: text => <div>{text == 0 ? 'Khóa học online web' : text == 1 ? 'Khóa học online zoom' : 'Khóa học offline'}</div>,
    },
    {
      title: 'Số tiền',
      dataIndex: 'amount',
