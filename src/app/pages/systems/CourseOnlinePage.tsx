...
import CourseOnlineProgramsPage from './course-online-programs/CourseOnlineProgramsPage';
import CourseOnlineProgramClassesPage from './course-online-programs/CourseOnlineProgramClassesPage';
    ...
    <>
      <Routes>
        <Route element={<Outlet />}>
          ...
          <Route path="courseonlineprograms" element={<CourseOnlineProgramsPage />} />
          <Route path="courseonlineprograms/:courseOnlineProgramId/course-classes" element={<CourseOnlineProgramClassesPage type={2} />} />
          <Route path="courseonlineprograms/:courseOnlineProgramId/course-classes/*" element={<CourseClassRoute />} />
