...
import ModalResetPass from '@/app/pages/systems/users/components/ModalResetPass';
...
const UsersList = props => {
  ...
  const handleButton = async (type, item) => {
    switch (type) {
      case 'chi-tiet':
        ...
        navigate(`/system/account/${item.id}/overview`, { state: { pathname: location.pathname } });
        break;
  ...
  return (
    <>
      ...
      {modalListVisible ? <ActiveCodeListModal modalVisible={modalListVisible} setModalVisible={setModalListVisible} /> : <></>}
