...
const ModalItem = props => {
  ...
  const RenderTabQuestion = () => (
    <div className="row">
      ...
      <div className="col-xl-6 col-lg-6">
        <FormItem label="Cấp độ" name="examArea" rules={[{ required: true, message: 'Không được để trống!' }]}>
          <TDSelect
            reload
            showSearch
            placeholder=""
      ...
      <Form.Item noStyle shouldUpdate={(prevValues, currentValues) => prevValues.type !== currentValues.type}>
        {({ getFieldValue }) =>
          getFieldValue('type') == 0 ? (
            ...
            <div className="row">
              <div className="col-xl-12">
                <FormItem label={'Đáp án'} name="answerString" rules={[{ required: true, message: 'Không được để trống!' }]}>
                  <Input placeholder="" />
                </FormItem>
              </div>
            </div>
