...
import ItemsList from './components/ItemsWaitList';
    ...
    <>
      <div className="card card-xl-stretch mb-xl-9">
        <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
          <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Khoá học chờ xác nhận'}</h3>
        ...
        <div className="row g-5 my-2">
          ...
          <div className="col-xl-6 col-lg-6 btn-group align-items-center px-5">
