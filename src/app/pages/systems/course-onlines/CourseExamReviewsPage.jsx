...
import ItemCourseExamReviews from '../courses/components/ItemCourseExamReviews';
      ...
      <div className="card card-xl-stretch mb-xl-3">
        <div className="px-3 py-3 d-flex align-items-center justify-content-between">
          <div className="d-flex align-items-center">
            ...
            <h3 className="card-title fw-bolder text-header-td fs-2 mb-0">{'Danh sách nhận xét bài đánh giá ' + (dataCourse?.title ?? '')}</h3>
          </div>
        </div>
      </div>
      <div className="card card-xl-stretch mb-xl-9">
        <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
          <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Lộ trình học'}</h3>
        ...
        <div></div>
        <ItemCourseExamReviews dataSearch={dataSearch} courseId={dataCourse?.id} />
      </div>
    </>
  );
};
