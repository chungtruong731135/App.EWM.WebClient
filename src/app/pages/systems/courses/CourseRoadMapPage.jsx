...
import ItemRoadMapList from './components/ItemRoadMapList';
  ...
  return (
    <>
      <div className="card card-xl-stretch mb-xl-3">
        <div className="px-3 py-3 d-flex align-items-center justify-content-between">
          <div className="d-flex align-items-center">
            ...
            <h3 className="card-title fw-bolder text-header-td fs-2 mb-0">{'Danh sách lộ trình khoá học ' + (dataCourse?.title ?? '')}</h3>
          </div>
        </div>
      </div>
      <div className="card card-xl-stretch mb-xl-9">
        ...
        <div></div>
        <ItemRoadMapList dataSearch={dataSearch} />
      </div>
    </>
  );
};
