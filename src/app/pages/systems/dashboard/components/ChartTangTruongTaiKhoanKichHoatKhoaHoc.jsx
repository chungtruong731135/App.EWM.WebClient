...
const RenderChartStatus = props => {
  ...
  const getOptionLine = _data => {
    ...
    setOptionLine({
      ...
      series: [
        {
          name: 'Tài khoản kích hoạt khoá học ',
          tooltip: {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await requestPOST(`api/v1/dashboards/tang-truong-tai-khoan-kich-hoat-khoa-hoc`, {
    ...
    <div className="card card-xl-stretch mb-xl-5 p-5 border-0">
      <div className="card-header ribbon ribbon-top ribbon-vertical px-3">
        <div className="card-title ">
          <span className="fa fa-chart-bar me-3 "></span> Biểu đồ tăng trưởng số lượng khách hàng kích hoạt khoá học
        </div>
