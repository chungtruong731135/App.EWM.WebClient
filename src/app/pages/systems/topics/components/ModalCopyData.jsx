...
const ModalItem = props => {
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = await requestPOST_NEW(`api/v1/topics/copy-topic`, formData);
          ...
          {!loadding && (
            ...
            >
              <div className="row">
                  ...
                  <FormItem label="Cấu hình sao chép">
                    <div className="row px-2">
                      <div className="col-xl-6 col-lg-6">
                        <FormItem label="Chủ đề nguồn" name="source" rules={[{ required: true, message: 'Không được để trống!' }]}>
                          <TDSelect
                            reload={true}
                            showSearch
                      ...
                      <div className="col-xl-6 col-lg-6">
                        <FormItem label="Chủ đề đích" name="destination" rules={[{ required: true, message: 'Không được để trống!' }]}>
                          <TDSelect
                            reload={true}
                            showSearch
                            placeholder="Chọn chủ đề đích"
                            fetchOptions={async keyword => {
                              const res = await requestPOST(`api/v1/topics/search`, {
                                pageNumber: 1,
                                pageSize: 1000,
                ...
                <div className="col-xl-6 col-lg-6">
                  <FormItem label="" name="copyQuestionLevel" valuePropName="checked">
                    <Checkbox>Copy chương trình học</Checkbox>
                  </FormItem>
                </div>
                <div className="col-xl-6 col-lg-6">
                  <FormItem label="" name="copyDeLuyenTap" valuePropName="checked">
