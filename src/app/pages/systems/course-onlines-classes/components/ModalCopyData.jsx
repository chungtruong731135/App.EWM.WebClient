...
const ModalItem = props => {
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = await requestPOST_NEW(`api/v1/courseclasses/copy-class`, formData);
                  ...
                  <FormItem label="Cấu hình sao chép">
                    <div className="row px-2">
                      <div className="col-xl-6 col-lg-6">
                        <FormItem label="Lớp học nguồn" name="source" rules={[{ required: true, message: 'Không được để trống!' }]}>
                          <TDSelect
                            reload={true}
                            showSearch
                      ...
                      <div className="col-xl-6 col-lg-6">
                        <FormItem label="Lớp học đích" name="destination">
                          <TDSelect
                            reload={true}
                            showSearch
