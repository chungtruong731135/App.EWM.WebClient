...
const ModalItem = props => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoadding(true);
      const res = await requestGET(`api/v1/bookpages/${id}`);
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = id ? await requestPUT_NEW(`api/v1/bookpages/${id}`, formData) : await requestPOST_NEW(`api/v1/bookpages`, formData);
            ...
            <Form form={form} layout="vertical" /* initialValues={initData} */ autoComplete="off">
              <div className="row">
                ...
                <div className="col-xl-6 col-lg-6">
                  <FormItem label="Thứ tự trang" name="pageNo">
