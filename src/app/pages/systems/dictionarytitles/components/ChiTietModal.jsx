...
const ModalItem = props => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoadding(true);
      const res = await requestGET(`api/v1/dictionarytitles/${id}`);
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = id ? await requestPUT_NEW(`api/v1/dictionarytitles/${id}`, formData) : await requestPOST_NEW(`api/v1/dictionarytitles`, formData);
          ...
          {!loadding && (
            <Form form={form} layout="vertical" autoComplete="off">
              <div className="row">
                ...
                <div className="col-xl-6 col-lg-6">
                  <FormItem label="Khoá học đích" name="course">
                    <TDSelect
                      reload={true}
                      showSearch
