          ...
          <div className="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
            <Link to="/dashboard">
              {config.layoutType === 'dark-header' ? (
                <img alt="Logo" src={toAbsoluteUrl(`media/images/logo${import.meta.env.VITE_APP_SYSTEM_TYPE}.svg`)} className="h-20px h-lg-30px app-sidebar-logo-default" />
              ) : (
                <>
                  <img alt="Logo" src={toAbsoluteUrl(`media/images/logo${import.meta.env.VITE_APP_SYSTEM_TYPE}.svg`)} className="h-20px h-lg-30px app-sidebar-logo-default theme-light-show" />
                  <img alt="Logo" src={toAbsoluteUrl(`media/images/logo${import.meta.env.VITE_APP_SYSTEM_TYPE}.svg`)} className="h-20px h-lg-30px app-sidebar-logo-default theme-dark-show" />
                </>
              )}
            </Link>
          </div>
